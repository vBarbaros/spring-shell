 ...
 */
public class LineReaderAutoConfiguration__TestContext001_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getLineReaderAutoConfigurationBeanDefinition() {
    Class<?> beanType = LineReaderAutoConfiguration.class;
    ...
    instanceSupplier = instanceSupplier.andThen(LineReaderAutoConfiguration__TestContext001_Autowiring::apply);
  ...
  public static BeanDefinition getLineReaderBeanDefinition() {
    Class<?> beanType = LineReader.class;
    RootBeanDefinition beanDefinition = new RootBeanDefinition(beanType);
