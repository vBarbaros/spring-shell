 ...
 */
public class StandardCommandsAutoConfiguration__TestContext001_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getStandardCommandsAutoConfigurationBeanDefinition() {
    Class<?> beanType = StandardCommandsAutoConfiguration.class;
  ...
  public static BeanDefinition getStacktraceBeanDefinition() {
    Class<?> beanType = Stacktrace.class;
    RootBeanDefinition beanDefinition = new RootBeanDefinition(beanType);
