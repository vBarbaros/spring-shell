...
import com.example.springshell.SpringShellApplicationTests__TestContext001_ApplicationContextInitializer;
...
public class AotTestContextInitializers__Generated {
  public static Map<String, Supplier<ApplicationContextInitializer<? extends ConfigurableApplicationContext>>> getContextInitializers(
    ...
    map.put("com.example.springshell.SpringShellApplicationTests", () -> new SpringShellApplicationTests__TestContext001_ApplicationContextInitializer());
    return map;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializerClasses(
    ...
    map.put("com.example.springshell.SpringShellApplicationTests", SpringShellApplicationTests__TestContext001_ApplicationContextInitializer.class);
    return map;
  }
}
